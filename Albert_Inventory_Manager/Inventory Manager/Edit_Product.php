...
if(isset($_POST['product'])){
    $req_fields = array('product-title','product-category','product-quantity','description', 'sale-price', 'ID' );
    ...
    if(empty($errors)){
        ...
        $query  .=" buy_price ='{$p_ID}', sale_price ='{$p_sale}', category_id ='{$p_cat}',media_id='{$media_id}', description_id'{$des_id}'";
